    ...
    return parts.map((part, i) =>
        urlRegex.test(part) ? (
            <a
                ...
                className={`underline break-all ${isOwnMessage ? 'text-blue-200 hover:text-white' : 'text-lime-400 hover:text-lime-300'}`}
            >
                {part}
            </a>
        ) : (
        ...
        <div className="flex h-screen bg-gray-950 text-gray-100">
            ...
            <div className="flex flex-col flex-1 h-screen">
                ...
                <div className="border-b border-gray-800 bg-gray-900 shadow-md">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <div>
                                <h2 className="font-semibold text-lg text-white">General Room</h2>
                                <p className="text-sm text-gray-400">A place for general discussions and community chat.</p>
                            </div>
                        </div>
                ...
                <div className="border-t border-gray-800 bg-gray-900 p-4">
                    ...
                    {replyingTo && (
                        <div className="mb-2 p-2 bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-between animate-in fade-in slide-in-from-bottom-1">
                            <div className="flex items-center gap-2 text-xs">
                                <Reply className="w-4 h-4 text-lime-400" />
                    ...
                    {uploadProgress && <div className="mb-2 text-xs text-lime-500 animate-pulse">{uploadProgress}</div>}
