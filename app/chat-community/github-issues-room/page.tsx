                ...
                <div className="border-b border-gray-800 bg-gray-900 shadow-md">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <div>
                                <h2 className="font-semibold text-lg text-white">GitHub Issues Room</h2>
                                <p className="text-sm text-gray-400">Discuss GitHub issues and collaborate on solutions.</p>
                            </div>
                        </div>
