...
export default function Chat4Page() {
    ...
    useEffect(() => {
        ...
        if (socketMessages.length > alreadyProcessed) {
            ...
            console.log(`Added ${newMessages.length} new socket messages to room4`);
        }
    }, [messages, room]);
                ...
                <div className="border-b border-gray-800 bg-gray-900 shadow-md">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <div>
                                <h2 className="font-semibold text-lg text-white">GSoC Org Discussion Room</h2>
                                <p className="text-sm text-gray-400">Discuss GSoC organization topics and collaborate on ideas.</p>
                            </div>
                        </div>
