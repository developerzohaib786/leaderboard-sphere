                        ...
                        return (
                            <div key={index} className={`mb-4 flex items-start gap-3 ${isOwnMessage ? 'flex-row-reverse' : 'flex-row'}`}>
                                ...
                                <div className={`flex-1 max-w-[70%] ${isOwnMessage ? 'flex flex-col items-end' : 'flex flex-col items-start'}`}>
                                    ...
                                    <div className={`inline-block rounded-lg shadow overflow-hidden ${isOwnMessage ? 'bg-blue-500 text-white' : 'bg-green-100'}`}>
                                        {msg.replyToText && (
                                            <div className={`text-xs px-3 pt-3 pb-2 border-b ${isOwnMessage ? 'border-blue-400' : 'border-green-300'}`}>
                                        ...
                                        {msg.rawFileUrl && (
                                            <div className={`px-3 py-2 ${msg.message ? 'border-b' : ''} ${isOwnMessage ? 'bg-blue-600 border-blue-400' : 'bg-green-50 border-green-200'}`}>
                                                <a
                                                    href={msg.rawFileUrl}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className={`flex items-center gap-2 ${isOwnMessage ? 'text-white' : 'text-green-600'}`}
                                                >
